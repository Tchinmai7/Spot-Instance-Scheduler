class JobsController < ApplicationController
  ...
  def create
    ...
    Job.delay.start_job(current_user,region,@job.machine_type)
  end
  ...
  private
    ...
    def job_params
      params.require(:job).permit(:servicename, :singlecontainer, :resourcepath, :command, :machine_type, :user_id)
    end
end
