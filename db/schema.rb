...
ActiveRecord::Schema.define(version: 20170313061448) do
  ...
  create_table "aws_keys", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id"], name: "index_aws_keys_on_user_id", using: :btree
  end

  create_table "bucket_configs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "bucketname"
